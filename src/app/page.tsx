...
function MyButton() {
  return (
    <a href="http://localhost:3000/" target="_blank" rel="noopener noreferrer" className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bgblue-600 transition duration-300">
      Buka Halaman
    </a>
  );
}
